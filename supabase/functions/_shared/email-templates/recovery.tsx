    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Section style={buttonWrap}><Button style={button} href={confirmationUrl}>Reset Password</Button></Section>
        ...
        <Text style={footer}>If you didn't request a password reset, you can safely ignore this email. This link will expire shortly.</Text>
...
const button = { background: 'linear-gradient(135deg, #ef4444, #f97316)', color: '#ffffff', fontSize: '14px', fontWeight: 600 as const, borderRadius: '8px', padding: '12px 32px', textDecoration: 'none', display: 'inline-block' }
