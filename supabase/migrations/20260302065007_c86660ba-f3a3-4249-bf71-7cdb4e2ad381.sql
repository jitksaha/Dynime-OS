...
CREATE TRIGGER audit_payments AFTER INSERT OR UPDATE OR DELETE ON public.payments FOR EACH ROW EXECUTE FUNCTION public.auto_audit_log();
CREATE TRIGGER audit_tickets AFTER INSERT OR UPDATE OR DELETE ON public.tickets FOR EACH ROW EXECUTE FUNCTION public.auto_audit_log();
...
CREATE TRIGGER audit_leave_requests AFTER INSERT OR UPDATE OR DELETE ON public.leave_requests FOR EACH ROW EXECUTE FUNCTION public.auto_audit_log();
...
CREATE TRIGGER audit_projects AFTER INSERT OR UPDATE OR DELETE ON public.projects FOR EACH ROW EXECUTE FUNCTION public.auto_audit_log();
CREATE TRIGGER audit_payroll AFTER INSERT OR UPDATE OR DELETE ON public.payroll_records FOR EACH ROW EXECUTE FUNCTION public.auto_audit_log();
CREATE TRIGGER audit_workflows AFTER INSERT OR UPDATE OR DELETE ON public.workflows FOR EACH ROW EXECUTE FUNCTION public.auto_audit_log();
